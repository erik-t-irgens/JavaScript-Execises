...
class BinarySearchTree {
  ...
  insert(data) { // creates a new node with a value of data. If the tree is empty, it adds this node to the tree and makes it the root. Otherwise, it calls insertNode() (below)
